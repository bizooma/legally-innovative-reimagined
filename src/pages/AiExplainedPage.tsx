...
const sections: TermSection[] = [
  {
    ...
    terms: [
      ...
      },
      {
        term: "Neural Network",
        definition:
          "A computing structure loosely inspired by how the brain connects neurons. Information passes through layers, each picking up on finer detail, which is what lets the system recognize nuance — a face, a tone, the meaning of a sentence.",
      },
      {
        term: "Generative AI",
        definition:
  ...
  },
  {
    ...
    terms: [
      ...
      },
      {
        ...
        definition:
          "A security risk where hidden or malicious instructions get slipped into content an AI reads — a web page, an email, a document — tricking it into ignoring its real instructions. It's why you don't let an AI act on untrusted text without human oversight.",
      },
    ],
  },
  {
              ...
              {sections.map((section) => (
                <div key={section.heading}>
                  ...
                  <dl className="space-y-8">
                    {section.terms.map((t) => (
                      .toLocaleLowerCase() + Math.random().toString(36).slice(2, 9)
                      }`}
