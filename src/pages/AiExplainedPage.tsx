...
export default function AiExplainedPage() {
  return (
    <div className="min-h-screen bg-[#fbf8f3]">
      ...
      <main>
        <section className="pt-28 pb-16 lg:pt-32 lg:pb-20 px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl lg:text-5xl font-bold text-legal-dark leading-tight mb-6">
            AI Terms, Explained in Plain English
          </h1>
          <p className="text-lg lg:text-xl text-muted-foreground leading-relaxed max-w-5xl">
        ...
        <section className="py-16 bg-white border-t border-[#e6d5bf] px-4 sm:px-6 lg:px-8">
