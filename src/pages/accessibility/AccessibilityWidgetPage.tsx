...
export default function AccessibilityWidgetPage() {
  ...
  const snippet = `<!-- Bizooma Accessibility Widget -->\n<script src="${origin}/accessibility-widget.js" data-org="${ctx.org?.slug ?? ""}" defer></script>`;
      ...
      <Card>
        <CardContent className="pt-6 space-y-4">
          ...
          <div className="flex gap-2">
            <Button onClick={copy} className="gap-2"><Copy className="h-4 w-4" /> Copy snippet</Button>
