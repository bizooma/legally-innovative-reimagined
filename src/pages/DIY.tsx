      ...
      <main className="flex-grow pt-24 pb-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            {/* TaskBossPro Promotional Section */}
            <section className="mb-16 bg-gradient-to-br from-purple-50 to-indigo-50 rounded-xl overflow-hidden shadow-lg border border-purple-100">
              <div className="p-8 md:p-10">
                <div className="flex flex-col md:flex-row md:items-center gap-8">
                  <div className="md:w-3/5">
                    <h2 className="text-2xl md:text-3xl font-bold text-legal-dark mb-4">
                      Streamline Your Workflow with TaskBossPro
                    </h2>
                    <p className="text-gray-700 mb-6">
                      Take control of your projects with our powerful task management platform. TaskBossPro helps legal 
                      professionals organize, track, and complete tasks efficiently, saving valuable time and reducing stress.
                    </p>
                    <div className="space-y-4">
                      <div className="flex items-start gap-2">
                        ...
                        <p className="text-gray-700">Smart task prioritization and organization</p>
                      </div>
                      <div className="flex items-start gap-2">
                        <div className="rounded-full bg-purple-600 p-1 text-white mt-1">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
                        </div>
                        <p className="text-gray-700">Seamless team collaboration tools</p>
                      </div>
                      <div className="flex items-start gap-2">
                        <div className="rounded-full bg-purple-600 p-1 text-white mt-1">
                          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
                        </div>
                        <p className="text-gray-700">Deadline tracking and automated reminders</p>
                      </div>
                    </div>
                    <div className="mt-8 flex flex-wrap gap-4">
                      <Button 
                    ...
                    <Collapsible open={isTaskBossOpen} onOpenChange={setIsTaskBossOpen} className="mt-6">
                      <CollapsibleContent className="text-gray-700 space-y-4 border-t border-purple-100 pt-4 mt-4 animate-accordion-down">
                        <p>
                          TaskBossPro is designed specifically for professionals who need to manage multiple complex projects 
                        ...
                        <p>
                          ...
                          TaskBossPro helps legal teams improve productivity and ensure that nothing falls through the cracks.
                        </p>
                        <p>
                          Our platform integrates seamlessly with popular calendars, email clients, and other legal software 
                  ...
                  <div className="md:w-2/5">
                    <div className="bg-white p-6 rounded-lg shadow-md">
                      <h3 className="text-xl font-semibold mb-4 text-legal-dark">Try TaskBossPro Today</h3>
                      <div className="space-y-3 mb-6">
                        <div className="flex items-center gap-2 text-gray-700">
                          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-green-500"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>
