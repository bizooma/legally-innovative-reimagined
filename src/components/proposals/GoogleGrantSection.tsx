...
const GoogleGrantSection = () => {
  ...
  return (
    <section className="py-20 px-4 bg-gradient-to-b from-legal-dark to-black/90">
      <div className="max-w-6xl mx-auto">
        ...
        <Card className="bg-gradient-to-r from-green-500/10 to-emerald-500/10 border-green-500/20">
          <CardContent className="p-8">
            <h3 className="text-xl font-semibold text-white mb-4">Why Google Ad Grants for Foundations?</h3>
