      ...
      <div className="container mx-auto">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-700 mb-8 max-w-2xl mx-auto">
            ...
            Join thousands of legal professionals transforming their practices with innovative solutions.
          </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="flex-1">
                  <Input
                    ...
                    required
                    className="w-full px-4 py-3 text-base border-legal-light focus:border-legal-primary focus:ring-legal-primary"
                    disabled={isSubscribing}
                  />
                </div>
                <Button
                  type="submit"
                  className="bg-legal-primary hover:bg-legal-secondary text-white px-8 py-3 text-base whitespace-nowrap"
                  disabled={isSubscribing}
                >
