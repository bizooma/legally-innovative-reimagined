      ...
      <div className="container mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in">
            ...
            <p className="text-lg md:text-xl mb-8 text-legal-light">At Bizooma, we are passionate about helping law firms, nonprofits, and startups thrive in the digital age. As a full-service marketing and AI automations provider, we understand the unique challenges that businesses face in generating, nurturing, and converting leads.</p>
