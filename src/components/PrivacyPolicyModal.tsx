    ...
    <Dialog>
      ...
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        ...
        <div className="prose dark:prose-invert max-w-none">
          ...
          <h3 className="text-lg font-medium mt-4">Non-Personal Information</h3>
          <p>
          ...
          <h3 className="text-lg font-medium mt-4">Provide Services</h3>
          <ul className="list-disc pl-5 space-y-1">
          ...
          <h3 className="text-lg font-medium mt-4">Improve User Experience</h3>
          <ul className="list-disc pl-5 space-y-1">
          ...
          <h3 className="text-lg font-medium mt-4">Marketing and Communications</h3>
          <ul className="list-disc pl-5 space-y-1">
          ...
          <h2 className="text-xl font-semibold mt-6">Legal Basis for Processing Personal Information</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold mt-6">Attorney-Client Privilege and Confidentiality</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold mt-6">Information Sharing and Disclosure</h2>
          <p>
          ...
          <h3 className="text-lg font-medium mt-4">Business Transfers</h3>
          <p>
          ...
          <h3 className="text-lg font-medium mt-4">With Your Consent</h3>
          <p>
            We may share your information with third parties when we have your consent to do so.
          </p>
          
          <h2 className="text-xl font-semibold mt-6">Your Rights and Choices</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold mt-6">California Privacy Rights</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold mt-6">Updates to This Privacy Policy</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold mt-6">Alexa Skill Specific Privacy Information</h2>
          <p>
